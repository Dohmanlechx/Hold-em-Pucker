//package com.dohman.holdempucker.trash
//
...
//                if (!isOngoingGame && !doNotShowMessage && !isJustShotAtGoalie) fNotifyMessage.invoke("Please choose a position.")
...
//        if (isAttacking) {
//            val flipAniX = objAnimator(
//                flipView,
//                View.TRANSLATION_X,
//                targetView.x - flipView.x - 30f
//            )
//            val flipAniY = objAnimator(
//                flipView,
//                View.TRANSLATION_Y,
//                targetView.y - flipView.y + 30f
//            )
//
//            return AnimatorSet().apply {
//                isAnimationRunning = true
...
//        } else {
//            val flipOutAni =
//                objAnimator(flipView, View.TRANSLATION_X, 2000f)
//            val victimOutAni =
//                objAnimator(targetView, View.TRANSLATION_X, 2000f)
//
//            return AnimatorSet().apply {
//                isAnimationRunning = true
...
//                    doOnEnd {
//                        // Both
//                        val attackerOutAni = objAnimator(
//                            flipView,
//                            View.TRANSLATION_X,
//                            2000f
//                        )
//                        val victimOutAni = objAnimator(
//                            targetView,
//                            View.TRANSLATION_X,
//                            2000f
//                        )
...
//            puck,
//            View.TRANSLATION_Y,
//            if (team.toLowerCase() == "bottom") 100f else -100f
//        )
//            .apply {
//                duration = 300
